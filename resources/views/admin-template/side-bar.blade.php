 <div class="sidebar-wrapper">
     <div>
         <div class="logo-wrapper"><a href="{{ url('/') }}"><img class="img-fluid for-light"
                     src="{{ url('assets/images/logo/logo-sankapo.png') }}" height="20%" alt=""><img
                     class="img-fluid for-dark" src="{{ url('assets/images/logo/logo-sankapo.png') }}" alt=""></a>
         ...
         <nav class="sidebar-main">
             ...
             <div id="sidebar-menu">
                 <ul class="sidebar-links" id="simple-bar">
                     ...
                     <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                                 data-feather="users"></i><span>Admin Users</span></a>
                         <ul class="sidebar-submenu">
