                                ...
                                <div class="table-responsive">
                                    <table class="display" id="advance-4">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$banner->title}}</td>
                                                <td><img src="/uploads/banners/{{$banner->bannerImage}}" width="100" height="100" alt=""></td>
                                                <td><a class="btn btn-info btn-xs" href="{{url('remove-category/'.$banner->id)}}">Remove</a>
                                                    <a class="btn btn-success btn-xs" href="{{url('approve/'.$banner->id)}}">Dsiplay</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
