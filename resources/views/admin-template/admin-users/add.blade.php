...
<html lang="en">
  <head>
    ...
    <title>Sankapo.com - Add New Admin</title>
                      ...
                      <div class="col-md-12">
                        <div class="card">
                          <div class="card-header">
                            <h5>Ad New Admin</h5><span>
                          </div>
                          <div class="card-body">
                            <form class="form-wizard" method="POST" action="{{url('http://127.0.0.1:8000/api/admin/signup/')}}" enctype="multipart/form-data">
                                @csrf
                              <div class="tab">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="category" name="email" type="text"   required="required">
                                </div>
                                <div class="mb-3">
