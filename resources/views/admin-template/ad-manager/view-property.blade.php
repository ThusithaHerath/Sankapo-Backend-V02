                         ...
                         <div class="row">
                           ...
                           <div class="col-md-3  border-start">
                             ...
                             <div class="d-flex flex-column mt-4">
                              <a class="btn btn-success btn-lg" type="submit"  href="{{url('approve-property/'.$data->id)}}">Approve</a>
                              <a class="btn btn-danger btn-lg mt-2" type="submit" href="{{url('decline-property/'.$data->id)}}">Decline</a>
                              <a class="btn btn-warning btn-lg mt-2" type="submit" href="{{url('http://127.0.0.1:8000/properties')}}">Back</a>
                             </div>
                           </div>
                         </div>
                       </div>
